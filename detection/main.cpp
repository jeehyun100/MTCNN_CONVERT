...
//    };
    ...
    std::string insight_trained_file = "../R34/model.caffemodel";
...
//    //mtcnn.detection(img, rectangles,confidence,points);
    //const float* feature = posface1.GetFeature(cropImage);
    posface1.GetFeature(cropImage);
...
//    std::cout << "Run " << ave_ffff << " times, "<<"Average time:" << ave << std::endl;
